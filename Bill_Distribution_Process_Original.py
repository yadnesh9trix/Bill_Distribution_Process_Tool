...
# bill_data = pd.read_excel(inppath + f"visitreports_19062023.xlsx")
bill_data = pd.read_excel(inppath + f"visitreports_28062023.xlsx")
...
# property_list_df['pid'] = 1
# merege_df = VisitPerson_rename.merge(property_list_df,on='propertycode',how='left')
# merege_df.to_excel(outpth + "Duplicated_bills_distributed_details.xlsx",index=False)
#-----------------------------------------------------------------------------------------------------------------------
propertyreceipt_df = pd.read_csv(inppath + "Property_Tax_Receipt_Amount_Dump.csv", low_memory=False,encoding='utf-8-sig')
#
...
try:
       ytddata_ty = pd.read_excel(paidamount_file + f"Paidamount_list_{report_date}.xlsx", sheet_name="Total")
except:
       ytddata_ty = pd.read_excel(paidamount_file + f"Paidamount_list_{report_date}.xlsx")
